...
func (handler *deprecationHandler) DeprecationV1(c *gin.Context) {
	errors := jsonapi.NewError([]string{"Gone"}, []string{"The v1 API has been deprecated. Please use the v2 API instead: https://app.swaggerhub.com/apis-docs/MurmurationsNetwork/LibraryAPI/2.0.0"}, nil, []int{http.StatusGone})
